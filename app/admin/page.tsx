                ...
                {themes.map(theme => (
                  <div key={theme.id} className="bg-white rounded-xl shadow-sm p-5 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        Manage Questions
                                        </a><button onClick={() => deleteTheme(theme.id, theme.name)} className="text-sm px-3 py-1.5 rounded-lg border border-red-200 text-red-600 hover:bg-red-50">Delete</button>
                  </div>
                </div>
                ))}
              </div>
